...
class FirstWorker4 implements Runnable {
	...
	public void run() {
		...
		while (true) {
			...
			counter = counter + 1;
			System.out.println("FirstWorker4 incremented the counter: " + counter);
...
class SecondWorker4 implements Runnable {
	...
	public void run() {
		...
		while (true) {
			...
			counter = counter - 1;
			System.out.println("SecondWorker4 decremented the counter: " + counter);
